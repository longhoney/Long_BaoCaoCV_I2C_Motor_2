...
void setup()
{
    ...
    Serial.begin(115200);
    Serial.println("Start Test, input from 1 to 5 (OFF)");
...
void loop()
{
    ...
    if (tempInput == '1')
    {
        ...
        myDriver.writeMA(1, 65);
        myDriver.writeMB(1, 65);
    }
    else if (tempInput == '2')
    {
        // myDriver.writeS1(90);
        // myDriver.writeS2(90);
        myDriver.writeMA(1, 100);
        myDriver.writeMB(1, 100);
    }
    else if (tempInput == '3')
    {
        // myDriver.writeS1(135);
        // myDriver.writeS2(45);
        myDriver.writeMA(0, 70);
        myDriver.writeMB(0, 70);
    }
    else if (tempInput == '4')
    {
        // myDriver.writeS1(0);
